...
{
    public class TimeEventDataWithTruncateCleanupWithTransactionsTests : IClassFixture<DatabaseFixtureTruncateCleanupWithTransactions>, IAsyncLifetime
    {
        private readonly DatabaseFixtureTruncateCleanupWithTransactions _fixture;
        ...
        public TimeEventDataWithTruncateCleanupWithTransactionsTests(DatabaseFixtureTruncateCleanupWithTransactions fixture,
