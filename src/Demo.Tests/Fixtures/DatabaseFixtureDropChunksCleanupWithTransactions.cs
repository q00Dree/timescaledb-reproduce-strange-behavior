...
{
    public class DatabaseFixtureDropChunksCleanupWithTransactions : DatabaseFixtureBase, IAsyncLifetime
    {
        public DatabaseFixtureDropChunksCleanupWithTransactions() : base()
        {
        }
